  ...
  render() {
    ...
    return (
      <div className="row post order-2">
        <Header
          img={headerImage || "https://i.imgur.com/bZ9BX0T.jpg"}
          title={title}
          authorName={name}
          authorImage={iconUrl}
        ...
        <div className="col-xl-7 col-lg-6 col-md-12 col-sm-12 order-10 content">
          ...
          <div className="m-message" style={bgWhite}>
            All the comments deserve to be WELCOMED!
          </div>
        ...
        <SEO
          title={title}
          url={slug}
          siteTitleAlt="Hoon's Blog"
          isPost={false}
          description={excerpt}
          image={headerImage || "https://i.imgur.com/bZ9BX0T.jpg"}
        />
      </div>
    )
  }
